...
export default function P1(){
    return(
      <main id="main-content" className="absolute bg-black w-full h-[100vh] overflow-auto">
        ...
        <LazyImage src="/cave.png" alt="3D visualization of Grand Caverns cave structure showing the exterior of the simulation" className='w-50 ml-20 lg:w-150 lg:ml-13 lg:mt-20' />
         ...
         of white-nose syndrome within a real cave environment.
          This image shows the exterior of our simulation,
           which accurately reflects the unique structure
            and formation of Grand Caverns—a local cave known
             to host bat populations affected by white-nose syndrome.</p>
